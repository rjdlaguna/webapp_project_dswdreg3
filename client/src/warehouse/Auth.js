...
const actions = {
  async login ({
    ...
    commit('auth_request')
    let res = await axios.post('http://104.248.144.145:9000/api/users/login', user)
  ...
  async register ({
    ...
    let res = await axios.post('http://104.248.144.145:9000/api/users/registeruser', user)
  ...
  async getProfile ({commit}) {
    ...
    let res = await axios.get('http://104.248.144.145:9000/api/users/profile')
  ...
  async getCenterIDByProfile ({
    ...
    commit('profile_request')
    let res = await axios.get('http://104.248.144.145:9000/api/users/getcenteridbyprofile' +id)
  ...
  async displayProfilePic ({commit}, id) {
      ...
      let res = await axios.get('http://104.248.144.145:9000/api/users/displayprofilepic/'+ id)
  ...
  async uploadProfilePic ({
    ...
    let res = await axios.post('http://104.248.144.145:9000/api/users/uploadprofilepic/' + id, imgForm) //,{headers: {'Content-Type': 'multipart/form-data' }})
  ...
  async updateAccountInfo({
    ...
    let res = await axios.post('http://104.248.144.145:9000/api/users/updateaccountinfo/'+ id, user_info)
  ...
  async changeUserPassword({
    ...
    let res = await axios.post('http://104.248.144.145:9000/api/users/changepassword/'+id, password_info)
  ...
  async registerCenter({
    ...
    let res = await axios.post('http://104.248.144.145:9000/api/users/registercenter', center)
  ...
  async displayCenters({
    ...
    let res = await axios.get('http://104.248.144.145:9000/api/users/displaycenters')
  ...
  async getCenterProfile({
    ...
    let res = await axios.get('http://104.248.144.145:9000/api/users/getcenterprofile/'+id)
  ...
  async displayCenterImage ({commit}, id) {
    ...
    let res = await axios.get('http://104.248.144.145:9000/api/users/displaycenterimage/'+ id)
  ...
  async uploadCenterPic ({
    ...
    let res = await axios.post('http://104.248.144.145:9000/api/users/uploadcenterpic/' + id, imgdata) //,{headers: {'Content-Type': 'multipart/form-data' }})
  ...
  async createCenterUser({
    ...
    let res = await axios.post('http://104.248.144.145:9000/api/users/createcenteruser', usercenter_data)
  ...
  async displayCenterUsers({
    ...
    let res = await axios.get('http://104.248.144.145:9000/api/users/displaycenterusers/' + id)
  ...
  async getAPIkey({
    ...
    let res = await axios.get('http://104.248.144.145:9000/api/users/getapikey')
  ...
  async getCenterData({
    ...
    let res = await axios.get('http://104.248.144.145:9000/api/users/getcenterdatabyuser/' + id)
  ...
  async updateCenterInfo({
    ...
    let res = await axios.get('http://104.248.144.145:9000/api/users/updatecenterinfo/' + id, centerdata)
  ...
  async sendIncidentReport({
    ...
    let res = await axios.get('http://104.248.144.145:9000/api/users/sendincidentreport', rptForm)
  ...
  async getMyIncidentReports({
    ...
    let res = await axios.get('http://104.248.144.145:9000/api/users/getmyincidentreports' + id)
